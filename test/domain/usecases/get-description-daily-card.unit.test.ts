...
import { GetDescriptionDailyCard } from "../../../src/domain/usecases/get-description-daily-card";
...
describe("GetDescriptionDailyCard usecase", () => {
	...
	beforeEach(() => {
		vi.clearAllMocks();
		sut = new GetDescriptionDailyCard(getDailyCardRepository);
	});
